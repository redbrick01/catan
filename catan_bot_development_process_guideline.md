...
이 문서는 카탄 프로젝트에 기본 플레이어봇을 구현할 때 따라야 하는 전용 개발 절차를 정의한다.

기존 `catan_implementation_process_guideline.md`의 절차를 기본으로 삼되, 봇 작업에서 특히 중요한 다음 요소를 추가로 강제한다.
...
docs/implementation_plans/2026-05-26_bot-mode-considerations.md
```
...
docs/implementation_plans/2026-05-26_bot-03-initial-placement-plan.md
...
docs/implementation_plans/2026-05-26_bot-08-ui-logging-plan.md
docs/implementation_plans/2026-05-26_bot-09-stabilization-regression-plan.md
```
...
```text
docs/implementation_plans/2026-05-26_bot-XX-...-plan.md
docs/test_plans/2026-05-26_bot-XX-...-test-plan.md
docs/final_reports/2026-05-26_bot-XX-...-final-report.md
```
