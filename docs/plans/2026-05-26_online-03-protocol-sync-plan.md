...
```text
docs/tests/2026-05-26_online-device-connection-test-result.md 기준으로 실제 접속 권장 조합은 http://100.88.125.81:4173/ + Chrome이다.
...
server.js
script.js
docs/tests/2026-05-26_online-03-protocol-sync-test-plan.md
