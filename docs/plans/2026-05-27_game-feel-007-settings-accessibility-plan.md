...
- `script.js`
  - `catanFeelSettings` schema, sanitize/load/save helpers, effective motion calculation, DOM dataset application, OS reduced-motion listener, and test hooks. 추가.
...
```text
localStorage key: catanFeelSettings
scope: 앱 전역 사용자 선호
