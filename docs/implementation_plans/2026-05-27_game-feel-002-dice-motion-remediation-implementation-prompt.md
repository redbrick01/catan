...
```text
카탄 프로젝트의 FEEL-002 주사위 굴림 모션 수정 계획을 구현해줘.
...
- docs/implementation_plans/2026-05-27_game-feel-002-dice-motion-remediation-plan.md
...
7. 문서 산출물을 갱신해.
   ...
   - docs/test_plans/2026-05-27_game-feel-002-dice-motion-remediation-test-plan.md
   - docs/final_reports/2026-05-27_game-feel-002-dice-motion-remediation-final-report.md
