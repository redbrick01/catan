...
- sound settings가 localStorage `katanFeelSettings`에 저장/복구됨.
...
전체 설정은 `katanFeelSettings` 안에 저장한다.
...
- `script.js`
  ...
  - Exposed sound mapping helpers through `window.__katanFeelTest` for test/debug use.
