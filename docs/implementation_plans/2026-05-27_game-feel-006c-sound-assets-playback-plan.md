...
작성일: 2026-05-27  
상위 계획: `docs/implementation_plans/2026-05-27_game-feel-006-sound-system-plan.md`  
...
또한 eventType별 기능 요구는 있지만 전체 사운드 팔레트의 통일감 기준이 부족하다. 카탄은 전투/액션 게임이 아니므로, 효과음은 과장된 arcade 톤보다 부드러운 프리미엄 UI 피드백, 보드게임의 촉감, 나무/종이/주사위/작은 종소리 같은 물성, 낮은 피로도, 반복 청취 가능성을 우선해야 한다.
...
- 공격적, 공포, 전투, 카지노 슬롯머신처럼 카탄 분위기와 어긋나는 효과음 사용
...
카탄의 사운드는 온라인 보드게임의 조용한 보조 감각이어야 한다.
...
- `docs/test_plans/2026-05-27_game-feel-006c-sound-assets-playback-test-plan.md`
- `docs/final_reports/2026-05-27_game-feel-006c-sound-assets-playback-final-report.md`
