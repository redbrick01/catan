...
관련 계획서: `docs/plans/2026-05-26_play-005-harbor-edge-model.md`
...
- `docs/reports/2026-05-26_play-005-harbor-edge-model-final-report.md`
...
- 인앱 브라우저 평가 환경에서 `window.__catanTest` 접근이 되지 않아 항구 교차점 소유 상태를 빠르게 주입하지 못했다.

## 5. 남은 위험

- 항구 위치는 기존 보드 모델 위에서 해안 edge를 추론해 만든다. 공식 보드 좌표 모델을 전면 도입한 것은 아니다.
- 항구 위치는 해안 edge 기준으로 개선되었지만, 공식 Catan 보드의 항구 고정 위치와 완전히 일치한다고 보장하지 않는다.
