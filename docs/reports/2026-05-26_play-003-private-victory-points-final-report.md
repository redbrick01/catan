...
관련 계획서: `docs/plans/2026-05-26_play-003-private-victory-points.md`
...
- `docs/reports/2026-05-26_play-003-private-victory-points-final-report.md`
...
- 인앱 브라우저의 평가 환경에서 `window.__catanTest`가 접근되지 않아 상태 주입 검증을 수행하지 못했다.
