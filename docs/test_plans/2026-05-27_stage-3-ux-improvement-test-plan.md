...
`docs/implementation_plans/2026-05-27_stage-3-ux-improvement-deepening-plan.md` 기준으로 턴 진행 안내, pending action 안내, 플레이어 교환 UX, 연결/재접속 오류 안내, 모바일 레이아웃, 로그 강조가 기존 온라인/봇 흐름을 깨지 않는지 확인한다.
