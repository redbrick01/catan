...
- 구현 계획: `docs/implementation_plans/2026-05-27_game-feel-007-settings-accessibility-plan.md`
- 변경 파일:
  - `index.html`
  - `script.js`
  - `styles.css`
...
- sound enabled와 volume을 바꾸고 `localStorage.katanFeelSettings`가 업데이트되는지 확인한다.
