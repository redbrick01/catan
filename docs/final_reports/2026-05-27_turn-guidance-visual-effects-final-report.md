...
기존 Stage 3 UX 개선에서 턴 안내 문구와 가이드 패널을 보강했지만, 텍스트가 많아지면 오히려 현재 진행 상태를 빠르게 파악하기 어렵다는 피드백이 있었다. 이에 따라 별도 계획서인 `docs/implementation_plans/2026-05-27_turn-guidance-visual-effects-plan.md`를 기준으로, 텍스트를 늘리지 않고 현재 진행자와 행동 필요 상태를 시각적으로 드러내는 작업을 독립 단위 개발로 분기했다.
...
- `docs/project-status-and-roadmap.md`의 UI/플레이 보조 상태를 갱신했다.
...
- `docs/test_plans/2026-05-27_turn-guidance-visual-effects-test-plan.md`
- `docs/final_reports/2026-05-27_turn-guidance-visual-effects-final-report.md`
