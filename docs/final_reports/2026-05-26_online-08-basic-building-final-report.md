...
docs/implementation_plans/2026-05-26_online-08-basic-building-plan.md
docs/test_plans/2026-05-26_online-08-basic-building-test-plan.md
```
...
docs/implementation_plans/2026-05-26_online-08-basic-building-plan.md
docs/test_plans/2026-05-26_online-08-basic-building-test-plan.md
docs/final_reports/2026-05-26_online-08-basic-building-final-report.md
```
...
PASS browser smoke: http://127.0.0.1:4173/?test=1 로드, title "카탄", 온라인 UI 존재, console error 없음
```
