...
- `docs/test_plans/2026-05-27_game-feel-006b-event-sound-mapping-test-plan.md`
...
- reload 이후 인앱 브라우저 평가 표면에서 `window.__katanFeelTest`가 보이지 않아 test-hook 검사는 제한되었지만, 앱 렌더링은 정상이었다. 매핑 동작은 정적 테스트가 커버한다.
