...
| 브라우저 smoke | 실제 로드, 콘솔 오류, 주요 화면 스크린샷 | `docs/test_plans/*.png` |
...
- [온라인 기기 연결 테스트 결과](../test_plans/2026-05-26_online-device-connection-test-result.md)
...
- [온라인 known issues](../known_issues/2026-05-26_online-13-known-issues.md)
